...
## TL;DR
Log into the [Silicon Valley Code Camp site](https://www.siliconvalley-codecamp.com/), go to your profile by clicking on your name (top right), add your Bluesky handle, and you’ll **automatically** be on either the Speakers or Attendees list (depending on whether you’ve presented before).

- **SVCC Speakers List**: [bsky.app/profile/pkellner.bsky.social/lists/3liadkspbne2m](https://bsky.app/profile/pkellner.bsky.social/lists/3liadkspbne2m)  
- **SVCC Attendees List**: [bsky.app/profile/pkellner.bsky.social/lists/3liadkspbne2m](https://bsky.app/profile/pkellner.bsky.social/lists/3liadkspbne2m)
...
- **Increased Visibility:** Early adopters are building robust professional circles.  
- **Community Growth:** Great for discovering new connections in specific niches (like our SV Code Camp community!).  
...
<img title="Placeholder for Login Button Screenshot" style="border-left-width: 0px; border-right-width: 0px; border-bottom-width: 0px; margin: 10px 10px 10px 3px; display: inline; border-top-width: 0px" border="0" alt="Placeholder for Login Button Screenshot" src="/postimages2025/login-button.png" width="300" align="right" />

## The Big News: Bluesky Lists for Speakers and Attendees
We at [Silicon Valley Code Camp](https://www.siliconvalley-codecamp.com/) are thrilled to announce our brand-new integration with Bluesky Lists. That means **all speakers and all attendees** who have a valid Bluesky handle can now be automatically added to our official lists for increased visibility:
...
<img title="Placeholder for Home Page Screenshot Once Logged In" style="border-left-width: 0px; border-right-width: 0px; border-bottom-width: 0px; margin: 10px 10px 10px 3px; display: inline; border-top-width: 0px" border="0" alt="Placeholder for Home Page Screenshot Once Logged In" src="/postimages2025/logged-in.png" width="320" align="left" />
...
<img title="Placeholder for Bluesky Speaker List Screenshot" style="border-left-width: 0px; border-right-width: 0px; border-bottom-width: 0px; margin: 10px 10px 10px 3px; display: inline; border-top-width: 0px" border="0" alt="Placeholder for Bluesky Speaker List Screenshot" src="/postimages2025/speakers-list.png" width="260" align="right" />

## More Exposure, More Influence
You might be wondering, “So, I’m on a list now, what’s the big deal?” Well, here’s what you can expect:

- **Easier Discovery**: People curious about the Silicon Valley Code Camp community can find you in one place.  
- **Follower Growth**: Lists can lead to higher engagement rates, as community members love discovering and following each other.  
- **Professional Credibility**: Being featured on an official list signals you’re part of the real deal—someone worth connecting with in the tech field.  
- **Collaboration Opportunities**: The Bluesky environment is an emerging space for devs and creators. Getting in early positions you to collaborate with forward-thinking individuals.
...
<img title="Placeholder for Bluesky Attendee List Screenshot" style="border-left-width: 0px; border-right-width: 0px; border-bottom-width: 0px; margin: 10px 10px 10px 3px; display: inline; border-top-width: 0px" border="0" alt="Placeholder for Bluesky Attendee List Screenshot" src="/postimages2025/attendees-list.png" width="280" align="left" />

## From Zero to Hero in the Tech Community
...
- **Your handle is unique** and portable—no risk of data lock-in.  
- **Your followers see more of you and less of algorithmic clutter** than on other social media platforms.  
- **Your presence is built on trust**—the entire premise of Bluesky is to put users first.
